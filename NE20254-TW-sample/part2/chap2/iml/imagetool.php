...
// 2005-10-04 JuK Add square option for ReCreatImg()
// 2005-10-03 JuK Mod remark file i/o({add|strip}slashes).
// 2005-03-11 JuK Mod NetPBM command invocation for Win32.
...
*/
  case 6:	// BMP
	  ...
	  $cmd = "bmptopnm ".escapeshellarg(escapeshellcmd($img_file))." | pnmtojpeg > ".escapeshellarg(escapeshellcmd($img_jpeg))."";
	  $cmd = "bmptopnm ".escapeshellarg(escapeshellcmd($img_file))." | pnmtojpeg > ".escapeshellarg(escapeshellcmd($img_jpeg))."";
	  $ret = system($cmd);
...
//	$qty: image quality for JPEG compression(0-100)
///////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////
function ReCreatImg0( $new_w, $new_h, $pic_frm, $frm_lbl, $img_file, $new_dir=".", $org_dir=".", $remark="", $rotangle=0, $smooth=true, $img_fmt="jpeg", $img_qty=81 )
{
